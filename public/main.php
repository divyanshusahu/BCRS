    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
      ...
      <div class="panel'; if($rowcomp['comp_status'] == 0){echo ' panel-danger';} if($rowcomp['comp_status'] == 1){echo ' panel-success';} echo '" style="margin-top:2%;">
        <div class="panel-heading">
          <h4 style="color:black;"><strong>Complaint-ID: '.$rowcomp["comp_id"].'</strong>&nbsp;&nbsp;&nbsp;<div class="visible-xs"></div>Type: '. $rowcomp["comp_type"].'<i style="float:right"> <i class="fa fa-clock-o"> </i>  '. calc_time((strtotime($cur_time) - strtotime($rowcomp["comp_time"]))) . show_time($type). '</i></h4>
        </div>
        <div class="panel-body">
          <p>'.htmlspecialchars($rowcomp["comp_text"]).'</p>
        </div>
        <div class="panel-footer">
        <h5><b>Room No: '. $row['room_no']. '&nbsp;&nbsp;&nbsp;<div class="visible-xs"></div> <span class="hidden-xs">Mobile No:</span> '. $row['mobile_no'].'
